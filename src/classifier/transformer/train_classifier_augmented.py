...
def main():
    ...
    # train is imbalanced (~24.5% human on the ranker-augmented data, up from ~2.7% on the
    # qrels-only data) -- oversample the minority class so batches aren't almost-always
    # all-generated.
